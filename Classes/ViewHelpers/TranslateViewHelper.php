<?php
namespace Derhansen\Standaloneview\ViewHelpers;
...
class TranslateViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
	...
	/**
	 * @var \Derhansen\Standaloneview\Service\LocalizationService
	 * @inject
	 */
	...
	protected function renderTranslation($id) {
		...
		$value = $this->translationService->translate($id, $extensionName, $this->arguments['arguments']);
		if ($value === NULL) {
